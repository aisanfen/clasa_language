...
# 随机选取字体
def getRandomFont():
    font_path='./font_ttf/font_Chinese'
...
def setfont():
    ...
    font = ImageFont.truetype('./font_ttf/font_Chinese/%s' % getRandomFont(), font_size, encoding='unic')
    name=getRandomFont()
    return name,font
...
def new_image(
    ...
    # 存文件
    #print(number)
    new_img.save(r'./picture_dateset/train/Chinese/Chinese_%s.png'%(str(number)).rjust(5,'0'))
...
if __name__ == '__main__':
  new_image_with_file('image_data_chinese.txt')